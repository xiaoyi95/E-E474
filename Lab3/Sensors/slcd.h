...
// Header file that includes the information needed for slcd.c
...
// Initializatoin instructions for the initialization sequence
...
static int don[8] = {0, 0, 0, 0, 1, 1, 1, 1};   // display on (no cursor)
...
static int l1c7[8] = {1, 0, 0, 0, 0, 1, 1, 0};  // Cursor moves to first line, 7th position
static int l2c13[8] = {1, 1, 0, 0, 1, 1, 0, 0};  // Cursor moves to second line, 13th position
